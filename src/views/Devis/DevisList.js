...
function DevisList() {
    ...
    const fetchDevis = async () => {
        ...
        try {
            const response = await axios.get(
                "http://localhost:8060/api/Gestionnaire/devis", {
                headers: {
                    Authorization: token,
                },
            });
                                        ...
                                        <TableCell>
                                            ...
                                            >
                                                <Box>
                                                    ...
                                                    <Button
                                                        variant="outlined"
                                                        color={devis.pack.type === "Basique" ? "primary" : "secondary"}
                                                        sx={{
                                                            mr: 1,
                                                            mb: {
                                                                xs: 1,
                                        ...
                                        <TableCell>
                                            ...
                                            >
                                                {/* <Box>
                                                    ...
                                                    >
                                                        {devis.typeOccupant.nom}
                                                    </Typography>
                                                </Box> */}

                                                <Button
                                                    variant="outlined"
                                                    color={devis.typeOccupant.nom === "Locataire" ? "primary" : "secondary"}
                                                    sx={{
                                                        mr: 1,
                                                        mb: {
                                                            xs: 1,
